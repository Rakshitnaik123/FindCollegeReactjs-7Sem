...
function FindCollegeContent() {
    ...
    useEffect(() => {
        document.getElementById("inputGRE").value = userData.gre;
        document.getElementById("inputTOEFL").value = userData.toefl;
        document.getElementById("inputSOP").value = userData.sop;
        document.getElementById("inputLOR").value = userData.lor;
        document.getElementById("inputCGPA").value = userData.cgpa;
        document.getElementById("inputResearch").value = userData.research;
        // eslint-disable-next-line
    }, [])

    function submitData(event) {
        event.preventDefault();
        data.gre = document.getElementById("inputGRE").value;
        data.toefl = document.getElementById("inputTOEFL").value;
        data.sop = document.getElementById("inputSOP").value;
        data.lor = document.getElementById("inputLOR").value;
        data.cgpa = document.getElementById("inputCGPA").value;
    ...
    if (!redirect) {
        ...
        // content = (<ShowColleges userData={userData} type="prediction"/>)
        content = (<Redirect to={{
            pathname: "/result",
            state: {userData, type: "prediction"}
        }} push/>)
    }
...
export default FindCollegeContent;